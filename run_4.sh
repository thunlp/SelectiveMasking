...
# OUTPUT_DIR=results/mr_mask_no_stop/30w_model_yelp/${SEED}/ckpt_${ITER}
OUTPUT_DIR=results/mr_mask_no_stop/10w_rand_yelp/${SEED}/ckpt_${ITER}
# OUTPUT_DIR=results/mr_mask_no_stop/small_bert/${SEED}/ckpt_${ITER}

# CKPT=results/mr_mask_no_stop/30w_model_yelp/checkpoints/best_ckpt_${ITER}.pt
CKPT=results/mr_mask_no_stop/10w_rand_yelp/checkpoints/best_ckpt_${ITER}.pt
