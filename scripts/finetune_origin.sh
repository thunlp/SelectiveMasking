...
DATA_DIR=${HOME}/SelectiveMasking/data/datasets/Aspect-Based-Sentiment-Analysis/14data_lap/
BERT_MODEL=pretrain_bert_model/bert-base-uncased/

OUTPUT_DIR=results/test/origin/${SEED}/ckpt_${ITER}
