...
DATASET=yelp_reverse_10dup # change this for other datasets
...
RESULTS_DIR=/home/gyx/nvidia-bert/results/yelp_reverse_10dup
CHECKPOINTS_DIR=/home/gyx/nvidia-bert/results/yelp_reverse_10dup/checkpoints
