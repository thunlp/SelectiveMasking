...
learning_rate=${2:-"0.2375e-4"}
precision=${3:-"fp16"}
num_gpus=${4:-8}
warmup_proportion=${5:-"0.01"}
train_steps=${6:-2285714}
save_checkpoint_steps=${7:-80000}
...
LOAD_MODEL=${HOMEGYX}/nvidia-bert/pretrain_bert_model/bert-base-cased/bert-base-cased.tar.gz
RESULTS_DIR=${HOMEGYX}/nvidia-bert/cased_4w_2
CHECKPOINTS_DIR=${HOMEGYX}/nvidia-bert/cased_4w_2/checkpoints
